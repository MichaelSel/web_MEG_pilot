...
jsPsych.plugins["audio-keyboard-response"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    function end_trial() {
      ...
      /*Edited for multiple key presses*/
      for(var i=0;i<all_responses.length;i++) {
        if(context !== null && all_responses[i].rt !== null){
          all_responses[i].rt = Math.round(all_responses[i].rt * 1000);
        }
      }
      ...
      for(var i=0;i<all_responses.length;i++) {
        trial_data.push({
            "rt": all_responses[i].rt,
            "stimulus": trial.stimulus,
            "key_press": all_responses[i].key
          });
      }
    ...
    if(context !== null) {
      var keyboardListener = jsPsych.pluginAPI.getKeyboardResponse({
        ...
        rt_method: 'audio',
        //Edited to record multiple key presses
        // persist: false,
        persist: true,
